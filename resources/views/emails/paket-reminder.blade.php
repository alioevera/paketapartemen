...
<head>
    <meta charset="UTF-8">
    <title>Pengingat Paket Belum Diambil</title>
</head>
    ...
    <div style="max-width:640px; margin:0 auto; padding:32px 20px;">
        <div style="background:#ffffff; border-radius:20px; padding:32px; box-shadow:0 8px 24px rgba(0,0,0,0.06);">
            <h1 style="margin:0 0 16px; font-size:26px; font-weight:800;">
                Pengingat Pengambilan Paket
            </h1>

            <p style="margin:0 0 20px; font-size:15px; line-height:1.8;">
                Halo <strong>{{ $penghuni->nama_penghuni }}</strong>, paket Anda masih berstatus
                <strong>belum diambil</strong>.
                Mohon segera mengambil paket Anda di resepsionis.
            </p>
            ...
            <table style="width:100%; border-collapse:collapse; margin-bottom:24px;">
                ...
                <tr>
                    <td style="padding:10px 0; font-weight:700;">Batas Pengambilan</td>
                    <td style="padding:10px 0;">{{ $batasPengambilan ?? '-' }}</td>
                </tr>
            </table>
            ...
            <div style="margin:24px 0; padding:20px; border:1px solid #e5e7eb; border-radius:16px; background:#fafaf9; text-align:center;">
                ...
                <p style="margin:0; font-size:16px; font-weight:700; color:#b45309;">
                    BELUM DIAMBIL
                </p>

                <p style="margin:10px 0 0; font-size:13px; color:#555;">
                    Segera ambil paket Anda sebelum melewati batas pengambilan.
                </p>
            </div>

            <p style="margin:20px 0 0; font-size:14px; line-height:1.8;">
                Jika paket sudah diambil namun status belum diperbarui, silakan hubungi resepsionis.
            </p>
        </div>
    </div>
</body>
